...
(function ($) {
    ...
    BootstrapTable.prototype.initPagination = function () {
        ...
        if (!this.options.onlyInfoPagination) {
            ...
            html.push('</span>');
            html.push('</div>',
	    		'<div class="goPagebtn"><input type="button" value="GO" class="pageBtn btn btn-default" onclick="toPage()"></div>',
    	        '<div class="goPage"><input id="goPageNum" class="pageNum form-control" type="text" value="'+this.options.pageNumber+'"></div>',
